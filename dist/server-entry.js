...
var _desc, _value, _class, _descriptor, _descriptor2; // 控制前端交互
...
var AppStateClass = (_class = function () {
  function AppStateClass() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { count: 0, name: 'dali' },
        count = _ref.count,
        name = _ref.name;
  ...
  AppStateClass.prototype.add = function add() {
    this.count += 1;
  };

  AppStateClass.prototype.changeName = function changeName(name) {
    this.name = name;
  };

  AppStateClass.prototype.toJson = function toJson() {
    // 拿到服务端的store渲染
    return {
      count: this.count,
      name: this.name
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppStateClass, 'AppStateClass', '/Users/zhalice/Desktop/React/React-Webpack/client/store/app-state.js');
}();
...
// 服务端渲染的store
(0, _mobxReact.useStaticRendering)(true); // 使用静态的渲染
// 服务端渲染的router
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/zhalice/Desktop/React/React-Webpack/client/server-entry.js');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(App, 'App', '/Users/zhalice/Desktop/React/React-Webpack/client/views/App.jsx');
}();
...
var _default = function _default() {
  return [_react2.default.createElement(_reactRouterDom.Route, { path: '/', render: function render() {
    ...
    }, exact: true, key: '/' }), _react2.default.createElement(_reactRouterDom.Route, { path: '/list', component: _index2.default, key: '/list' }), _react2.default.createElement(_reactRouterDom.Route, { path: '/detail', component: _index4.default, key: '/detail' }), _react2.default.createElement(_reactRouterDom.Route, { path: '/test', component: _apiTest2.default, key: '/test' })];
}; // 路由配置的文件
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/zhalice/Desktop/React/React-Webpack/client/config/router.jsx');
}();
  ...
  TopicList.prototype.render = function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('meta', { name: 'description', comtent: '\u54C8\u54C8\u54C8' })
      ),
...
TopicList.propTypes = {
  appState: _propTypes2.default.instanceOf(_appState.AppState) // 表示appState是一个对象 并且是必须传入的对象
};
;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicList, 'TopicList', '/Users/zhalice/Desktop/React/React-Webpack/client/views/topic-list/index.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicDetail, 'TopicDetail', '/Users/zhalice/Desktop/React/React-Webpack/client/views/topic-detail/index.jsx');
}();
...
var TestApi = function (_React$Component) {
  ...
  TestApi.prototype.componentDidMount = function componentDidMount() {
    // do something
  };
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TestApi, 'TestApi', '/Users/zhalice/Desktop/React/React-Webpack/client/views/test/api-test.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppState, 'AppState', '/Users/zhalice/Desktop/React/React-Webpack/client/store/store.js');

  __REACT_HOT_LOADER__.register(createStoreMap, 'createStoreMap', '/Users/zhalice/Desktop/React/React-Webpack/client/store/store.js');

  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/zhalice/Desktop/React/React-Webpack/client/store/store.js');
}();
